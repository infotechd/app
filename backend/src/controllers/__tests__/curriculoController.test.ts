...
describe('Curriculo Controller', () => {
  ...
  describe('updateCurriculo', () => {
    ...
    it('should update curriculo successfully for a prestador', async () => {
      ...
      (Curriculo.findOneAndUpdate as jest.Mock).mockResolvedValue(mockUpdatedCurriculo);
    ...
    it('should return 404 if no curriculo found for the prestador', async () => {
      ...
      (Curriculo.findOneAndUpdate as jest.Mock).mockResolvedValue(null);
    ...
    it('should call next with error if an exception occurs', async () => {
      ...
      const error = new Error('Database error');
      (Curriculo.findOneAndUpdate as jest.Mock).mockRejectedValue(error);
